        ...
        new Thread() {
            ...
            public void run() {
                ...
                keyword = keyword10.get(ran);
                    ...
                    String searchWord = URLEncoder.encode(keyword, "UTF-8");   //한글로 된 키워드를 utf-8형식으로 인코딩 해줌.

                    //해당 키워드를 검색해주는 url 작성.
                    String apiURL = "https://openapi.naver.com/v1/search/news.xml?query=" + keyword + "&display=5&start=1&sort=sim";
